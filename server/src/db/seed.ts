 ...
 */
const ACCOUNTS: Array<{ username: string; password: string; displayName: string; role: 'super_admin' | 'admin' | 'player' }> = [
  { username: 'admin', password: 'admin123', displayName: 'Shivansh', role: 'super_admin' },
